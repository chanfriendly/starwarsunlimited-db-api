...
export function MainNav() {
    ...
    const navLinks = [
        { href: "/deck-builder", label: "Deck Builder", active: pathname === "/deck-builder", icon: <Swords className="h-4 w-4 mr-2" /> },
        { href: "/cards", label: "Card Browser", active: pathname === "/cards", icon: <Book className="h-4 w-4 mr-2" /> },
        { href: "/my-decks", label: "My Decks", active: pathname === "/my-decks", icon: <Bookmark className="h-4 w-4 mr-2" /> },
        { href: "/community", label: "Community", active: pathname === "/community", icon: <Users className="h-4 w-4 mr-2" /> },
    ];
            ...
            <div className="container flex h-16 items-center px-4 sm:px-6 justify-between">
                        ...
                        <div className="flex flex-col h-full">
                            ...
                            <div className="relative mb-6">
                                ...
                                <Input
                                    ...
                                    className="pl-9 bg-zinc-900/70 border-zinc-700/50 text-white"
                                />
                            </div>
                ...
                <div className="flex items-center space-x-4">
                    <div className="relative hidden md:flex w-full max-w-sm items-center">
                        ...
                        <Input
                            placeholder="Search cards..."
                            className="pl-9 bg-zinc-900/70 border-zinc-700/50 w-full text-white"
                        />
                    </div>
                    <ThemeToggle />
                    {/* Replace with your actual UserNav Component */}
                    {/* <UserNav /> */}
